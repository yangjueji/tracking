...
The contribution of the TLD is a formalization of the P-N learning paradigm for off-line and on-line learning problems. We provide a theoretical analysis of the process and specify conditions under which the learning guarantees improvement of the initial classifier. In the experimental section, we apply the P-N learning to training an object detector during tracking. We propose simple yet powerful constraints that restrict the labeling of patches extracted from video. Our learning method is processing the video sequence in real-time and the resulting detector achieves state-of-the-art performance.
